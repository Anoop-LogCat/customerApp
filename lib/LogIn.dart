        ...
        SizedBox(height: 20,),
          RaisedButton(
            ...
            child: Container(
              ...
              child: Text('Log in',style: TextStyle(fontSize: 20,color:Colors.black,fontWeight: FontWeight.bold),),
            ),
          ),
        SizedBox(height: 20,)
      ],
  ...
  Widget otherLogin(){
    return Container(
      ...
      child: Row(
        ...
        children: [
          Text('Also Login With',style: TextStyle(fontSize: 15,color:globals.getColorFromHex('f6eedf'),fontWeight: FontWeight.bold),),
